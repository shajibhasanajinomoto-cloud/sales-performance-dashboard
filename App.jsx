...
function buildLiveSectionsWide(rawRows) {
  ...
  const colMeta = filledRow1.map((brandLabel, i) => {
    if (i < baseCols || i === monthColIndex) return null;
    ...
    <div className="min-h-screen" style={{ background: CREAM, fontFamily: "'Inter', sans-serif" }}>
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                {page === "dashboard" && targetData?.hasMonths ? (
                  <span className="text-[11px] text-white/50 font-medium">{selectedTargetMonth || targetData.months[0]}</span>
                ) : (
      ...
      <>
        ...
        <div className="flex gap-3 mb-6 flex-wrap">
          ...
          <KpiCard label="Result" value={fmt(totals.achv)} sub="KG, current month" icon={Target} accent={GREEN} />
